		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="book_stock" class="form-control" required="">
				</div>
				<div class="form-group">
...
<?php
	if(isset($_POST['add_book'])){
		...
		$query = "insert into books values(null,'$_POST[book_name]','$_POST[book_author]','$_POST[book_cat]',$_POST[book_no],$_POST[book_stock],$_POST[book_price])";
