...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
	<div class="container-fluid">
		<ul class="nav navbar-nav navbar-center">
			...
			<li class="nav-item">
				<a href="issue_book.php" class="nav-link">Return Book</a>
			</li>
		</ul>
	</div>
</nav>
		...
		<div class="col-md-4">
			<form action="" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="book_stock" value="<?php echo $book_stock;?>" class="form-control" required="">
				</div>
				<div class="form-group">
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "update books set book_name = '$_POST[book_name]',author_id=$_POST[author_id],cat_id=$_POST[cat_id],book_price = $_POST[book_price],book_stock = $_POST[book_stock] where book_no = $_GET[bn]";
		$query_run = mysqli_query($connection,$query);
