<?php
	...
	$student_id="";
	$issue_date="";
	$query = "select issued_books.book_name,issued_books.book_author,issued_books.book_no,issued_books.student_id,issued_books.issue_date,users.name from issued_books left join users on issued_books.student_id = users.id";
?>
<!DOCTYPE html>
<html>
<head>
...
<center><h2>View List Of Issued Books </h2></center>
<div class="row">
