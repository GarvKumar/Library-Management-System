<?php
    ...
    $issue_date="";
	$return_date ="";
	$query = "select return_book.book_name,return_book.book_author,return_book.book_no,return_book.student_id,return_book.issue_date,return_book.return_date,users.name from return_book left join users on return_book.student_id = users.id";
?>
<!DOCTYPE html>
<html>
<head>
...
<center><h2>View List Of Return Books </h2></center>
<div class="row">
